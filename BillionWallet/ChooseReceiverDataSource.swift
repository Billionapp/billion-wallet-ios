//
//  ChooseReceiverDataSource.swift
//  BillionWallet
//
...
protocol ChooseReceiverDataSourceDelegate: class {
    func didSelect(at index: Int)
    func scrollViewDidScroll(_ scrollView: UIScrollView)
}

class ChooseReceiverDataSource: NSObject, UITableViewDelegate, UITableViewDataSource {
    
    weak var viewModel: ChooseReceiverVM!
    weak var delegate: ChooseReceiverDataSourceDelegate?
    
    init(viewModel: ChooseReceiverVM) {
...
extension ChooseReceiverDataSource: DZNEmptyDataSetSource {
